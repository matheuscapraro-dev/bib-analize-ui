      ...
      <Tabs defaultValue="chart">
        ...
        <TabsContent value="chart">
          <ChartContainer ref={barRef} title={`Top ${topCount} Instituições`} actions={<ChartExportButton chartRef={barRef} fileName="top-instituicoes" />}>
            <BarChart data={chartData} xKey="name" bars={[{ key: "count", label: "Documentos" }]} layout="vertical" height={Math.max(350, topCount * 25)} />
          </ChartContainer>
        </TabsContent>
        ...
        <TabsContent value="table">
          <Card>
            ...
            <CardContent>
              <DataTable columns={columns} data={tableData} searchColumn="name" searchPlaceholder="Buscar instituição..." />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
